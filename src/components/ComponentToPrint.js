    ...
    render() {
      ...
      return (
        <div className='fixed w-fit bottom-1/2 right-1/2 translate-x-1/2 translate-y-1/2 border-2 py-4 px-2'>
            ...
            <h1 className='text-center text-2xl mt-4'>Hello, <span className="font-semibold">{custName}</span></h1>
            <h2 className='text-center text-xl mt-4'>Your queue Number is <span className="font-semibold">{appNum}</span></h2>
